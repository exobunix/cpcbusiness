  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-20 text-center px-6 relative">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-white mt-4 mb-6">We Build Digital Empires</h1>
            <p className="text-gray-400 text-lg leading-relaxed">Founded in 2014, CPCBusiness has grown from a 3-person boutique agency to a 50+ strong enterprise digital powerhouse trusted by companies in 30+ countries.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-8">
        {[
          { icon: Target, title: "Our Mission", text: "To empower ambitious companies with world-class digital solutions that drive measurable growth and lasting competitive advantage." },
          { icon: Eye, title: "Our Vision", text: "To be the most trusted enterprise technology partner in the world — where innovation meets execution and every build becomes a landmark." },
        ].map((item, i) => (
          <motion.div
            key={item.title}
